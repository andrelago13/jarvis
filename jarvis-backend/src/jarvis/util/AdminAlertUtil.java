...
public class AdminAlertUtil {
    ...
    private static final String MSG_NO_DB_CONNECTION = "There seems to be no connection to the database.";
    private static final String MSG_DB_ERROR = "There was an error with the Jarvis DB: ";
